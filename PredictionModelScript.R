...
### Not using distance in our model so I will call only the data we need from read.data.R
...
maxtemponeday <- subset(maxtemp, LengthForecastDayOnly == 1)
...
maxtemplagscomp <- maxtemp[complete.cases(maxtemp$adjmeanhum, 
  maxtemp$adjmeanwind), ] 

summary(maxtemplagscomp$Date)
...
#### Train and test are now split into: train - 2014/09/01 - 2016/08/31, test - 2016/09/01 - 2017/09/01
